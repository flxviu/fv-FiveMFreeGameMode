Config = {
    ...
    MenuKeybind = 'F1', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
    ...
    MenuImage = "https://media.discordapp.net/attachments/1282273370158792786/1319935941632196688/static.png?ex=6767c5a3&is=67667423&hm=e8ef81f0e7b3d4ba369120415ecea6c7053a1878cfcf7c6f802a0489d658c8a0&=&format=webp&quality=lossless&width=455&height=160", ----[Custom banner imgur URLs go here ]---
...
Config.Languages = {
    ['en'] = { -- English 🇬🇧
        ['whitecustom'] = '~b~AnimatiiV1~w~',
        ['whitecustom2do'] = '~b~AnimatiiV2~w~',
        ['emotes'] = 'Animatii 🎬',
        ['danceemotes'] = "🕺 Dansuri",
        ['animalemotes'] = "🐩 Emote-uri Animale",
