local lang = {
  common = {
    welcome = "Bine ai venit pe ~b~Anubis RomaniaRoleplay",
  ...
  money = {
    ...
    Giftpoints = "<span class=\"symbol\">Giftpoints</span> {1}",
  ...
  coins = {
    ...
    given = "Succes: Ai dat ~r~{1} ~w~(de) €.",
    received = "Succes: ~w~Ai primit ~b~{1} ~w~(de) €.",
    not_enough = "Eroare: ~w~Nu ai destule Lucid coins",
    paid = "Succes: ~w~Ai platit ~r~{1} ~w~(de) €.",
    give = {
      title = "Ofera Coins",
  ...
  donationCoins = {
    display = "<span class=\"symbol\">€</span> {1}",
    bdisplay = "<span class=\"symbol\">€</span> {1}",
    Giftpoints = "<span class=\"symbol\">Lucid Coins</span> {1}",
    donationCoins = "<span class=\"symbol\">DonationCoins</span> {1}",
    given = "Succes: Ai dat ~r~{1} ~w~(de) €.",
    received = "Succes: ~w~Ai primit ~b~{1} ~w~(de) €.",
  ...
  home = {
    ...
    gametable = {
      ...
      bet = {
        ...
        request = "[BET] Vrei sa pariezi {1} (de) €?",
