...
function vRP.setUserSponsor(user_id,sponsor)
	...
	exports.oxmysql:execute("UPDATE vrp_users SET sponsorRank = @sponsor WHERE id = @user_id", {user_id = user_id, sponsor = sponsor}, function()end)
end
...
AddEventHandler("vRP:playerJoin",function(user_id,source,name,last_login)
	local rows = exports.oxmysql:executeSync("SELECT * FROM vrp_users WHERE id = @user_id", {user_id = user_id})
