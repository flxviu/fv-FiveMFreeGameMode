...
UTK.hacktime = 5000 * 20 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
UTK.maxcash = 5000000 -- maximum amount of cash a pile can hold
UTK.mincash = 2000000 -- minimum amount of cash a pile holds
UTK.black = false -- enable this if you want blackmoney as a reward
UTK.blackmoney = "dirty_money" -- item you receive when you use UTK.blackmoney
...
UTK.PolicePermission = "police.service" -- permission for the cops
UTK.Banks = {
    Alta = {
        doors = {
